...
gin+	gorm+redis+viper+JWT+Nginx
...
assets：目录下保存上传的视频文件；default下面存放默认的头像和背景图
...
1. user：
> Avatar string  `gorm:"default:'http://服务器IP:80/default/avatar.jpg'" json:"avatar"`  // 用户头像

>BackgroundImage string  `gorm:"default:'服务器IP/default/background.jpg'" json:"background_image"` // 用户背景
